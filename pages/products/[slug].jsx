    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            alt="ecommerce"
            className="mx-auto px-5 lg:w-1/2 h-[80vh] lg:h-auto"
            src="https://m.media-amazon.com/images/I/61u8Z9UvBlS._AC_UL480_FMwebp_QL65_.jpg"
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="mt-5 flex">
              <input
                type="number"
                className="p-2 my-2 border-4 border-gray-400 rounded-xl"
                placeholder="Pincode"
                onChange={(e) => setPin(e.target.value)}
              />
              <button
                className="ml-2 my-2 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded"
